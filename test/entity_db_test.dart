...
void main() {
  Server.initialize(name: 'entity_cache/entity_cache_test', level: Level.debug);

  group('Entity Cache Tests', () {
    const dirPath = 'C:/odw/vna/test/entity_cache';
    final vnaCache = VnaUidCache.empty(dirPath);
    final entities = vnaCache.entities;
    ...
    test('PatientCache Test add(Patient)', () {
      global.throwOnError = false;

      final patients = PatientCache(dirPath);
    ...
    test('PatientCache Test []=', () {
      global.throwOnError = false;

      final patients = vnaCache.patients;
    ...
    test('Study Test add(Study)', () {
      ...
      final studies = StudyCache(dirPath);
    ...
    test('StudyCache Test []=', () {
      global.throwOnError = false;

      final studies = vnaCache.studies;
    ...
    test('Series Test add(Study)', () {
      ...
      final series = SeriesCache(dirPath);
      final eLength = entities.length;
    ...
    // [entities] not used in this test.
    test('SeriesCache Test []=', () {
      global.throwOnError = false;

      final series = vnaCache.series;
    ...
    test('Instance Test add(Instance)', () {
      ...
      final instances = InstanceCache(dirPath);
      final eLength = entities.length;
    ...
    // [entities] not used in this test.
    test('InstanceCache Test []=', () {
      global.throwOnError = false;

      final instances = vnaCache.instances;
